...
public enum Token {
    ...
    OPEN_PARENTHESIS, CLOSE_PARENTHESIS, ESTRUCTURA_DE_CONTROL,BOOLEAN, PREDEFINEDVARIABLE, OPEN_SQUAREBRACKET, CLOSE_SQUAREBRACKET, OPEN_CURLYBRACKET, CLOSE_CURLYBRACKET, RECORDSET, COMMENT,
